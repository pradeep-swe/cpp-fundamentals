/*
    Program to simulate a ball being dropped off of a tower. To start, the user is asked for the height of the tower in meters. <br> Assuming normal gravity (9.8 m/s2), and that the ball has no initial velocity (the ball is stationary at start). Have the program <br> output the height of the ball above the ground after 0, 1, 2, 3, 4, and 5 seconds. The ball should not go underneath the ground (height 0). <br>
*/
#include <iostream>
